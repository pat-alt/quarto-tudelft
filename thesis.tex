...
%%==== colors from yaml ===%
\definecolor{RQ-color1}{HTML}{dff3ee}
\definecolor{RQ-color2}{HTML}{009B77}
\definecolor{TRQ-color1}{HTML}{80cdbb}
\definecolor{TRQ-color2}{HTML}{009B77}
%=============%
...
\begin{tcolorbox}[enhanced jigsaw, breakable, bottomrule=.15mm, opacityback=0, left=2mm, colback=white, colframe=quarto-callout-note-color-frame, rightrule=.15mm, arc=.35mm, toprule=.15mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, bottomrule=.15mm, opacityback=0, left=2mm, colback=white, colframe=quarto-callout-tip-color-frame, rightrule=.15mm, arc=.35mm, toprule=.15mm, leftrule=.75mm]
\begin{minipage}[t]{5.5mm}
