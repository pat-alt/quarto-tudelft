...
\begin{titlepage}
    ...
    \begin{center}
        ...
        {\Large\titlefont\bfseries Patrick Altmeyer}
    ...
    \vfill
        \begin{center}
                                \includegraphics[height=1in]{\_extensions/tudelft/www/tudelft.png}\hspace{1cm}
                        \end{center}
    \vfill
    ...
    \begin{tabular}{@{}p{0.2\textwidth}@{}p{0.8\textwidth}@{}}
        \textit{Keywords:}    & templatedemo                                                                                        \\[\medskipamount]
    ...
    \noindent Copyright \textcopyright{} \the\year{} by Patrick Altmeyer
