...
\begin{tcolorbox}[enhanced jigsaw, colback=white, toprule=.15mm, breakable, opacityback=0, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, arc=.35mm, rightrule=.15mm, leftrule=.75mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, toprule=.15mm, breakable, opacityback=0, bottomrule=.15mm, colframe=quarto-callout-tip-color-frame, arc=.35mm, rightrule=.15mm, leftrule=.75mm, left=2mm]
\begin{minipage}[t]{5.5mm}
