...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, opacityback=0, bottomrule=.15mm, arc=.35mm, breakable, colframe=quarto-callout-note-color-frame, rightrule=.15mm, colback=white, leftrule=.75mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, opacityback=0, bottomrule=.15mm, arc=.35mm, breakable, colframe=quarto-callout-tip-color-frame, rightrule=.15mm, colback=white, leftrule=.75mm, toprule=.15mm]
\begin{minipage}[t]{5.5mm}
