...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, breakable, left=2mm, rightrule=.15mm, bottomrule=.15mm, opacityback=0, colback=white, arc=.35mm, toprule=.15mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-tip-color-frame, breakable, left=2mm, rightrule=.15mm, bottomrule=.15mm, opacityback=0, colback=white, arc=.35mm, toprule=.15mm, leftrule=.75mm]
\begin{minipage}[t]{5.5mm}
