...
$endif$
    ...
    \vfill
        ...
        $if(institute-logos)$
        $for(institute-logos)$
                \includegraphics[height=1in]{$institute-logos.path$}$if(institute-logos.spacing)$\hspace{$institute-logos.spacing$}$else$\hspace{1cm}$endif$
        $endfor$
        $else$
        $if(institute-logo)$
                \includegraphics[height=1in]{$institute-logo$}
        $endif$
        $endif$
        \end{center}
    \vfill
